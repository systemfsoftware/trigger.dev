...
If you see an error like this then you've bundled `@systemfsoftware/trigger.dev_sdk/v3` into your frontend code:
...
When you use server actions that use `@systemfsoftware/trigger.dev_sdk/v3`:
